...
import smlogo from "../src/logo-sm.png";
        ...
        <div className="p-3">
          ...
          >
            <img
              ...
              alt="Side Panel Logo"
              className={`transition duration-0 ease-in-out ${
                isOpen ? "w-36" : "w-8"
              }`}
            />
          </button>
            ...
            >
              <FaHome
                className={`text-black group-hover:text-[#34c38f] transition duration-300 ease-in-out ${
                  isDarkMode ? "text-[#898fa9]" : "text-black"
                }`}
              />
              {isOpen && (
                <a
      ...
      >
        ...
        <nav
          className={`top-0 left-0  w-full flex items-center justify-between p-4 ${
            isDarkMode ? "bg-[#2a2e3a]" : "bg-white shadow-blue-600"
